...
function input_ui_horizontal_pressed() {
	...
	if (v == 0) {
		v = scr_keyboard_check_pressed(vk_right) - scr_keyboard_check_pressed(vk_left)
	}
	
	if (v == 0) {
		v = scr_keyboard_check_pressed(keymap_get("east")) - scr_keyboard_check_pressed(keymap_get("west"))
	}
