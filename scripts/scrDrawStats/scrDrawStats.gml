function scrDrawStats() {
    var runs, wins, dailies, bkill, brace, barea, bsuba, bloop, hkill, hrace, harea, hsuba, hloop, dkill, drace, darea, dsuba, dloop, bstrk, cstrk, frace, ftime, loop;
