...
if !instance_exists(Player) {
    ...
    if !instance_exists(DailyList) && !UberCont.bossintro && !instance_exists(MenuOptions) {
        if UberCont.daily_run {
            draw_sprite_ext(sprPlayButtons, 1 + UberCont.weekly_run, _x + 1, _y + 1, 1, 1, 0, c_black, 1)
            draw_sprite_ext(sprPlayButtons, 1 + UberCont.weekly_run, _x, _y + 1, 1, 1, 0, c_black, 1)
            draw_sprite_ext(sprPlayButtons, 1 + UberCont.weekly_run, _x, _y, 1, 1, 0, c_white, 1)
        }
